# -*- coding: utf-8 -*-
"""
Created on Tue May 29 13:45:33 2018
...
# Montecarlo Simulation  ( asset´s daily volatility)
...
# Simulation using Browninan Motion
...
#  Theoretical Value at Risk with given portfolio and simulation outputs
 ...
 #  key statistics
    ...
    def key_stats(self):
        ...
        ##print ("Probability price is between 30 and 40: "),  ("{0:.2f}%").format((float(len(price_array[(price_array&gt; 30) &amp; (price_array&lt;- 40)])) / float(len(price_array)) * 100)) print "Probability price is &gt; 45: ", "{0:.2f}%".format((float(len(price_array[price_array &gt; 45])) / float(len(price_array)))* 100)
